...
class Network:
    def __init__(self, input_n: int, hiddens_n: list, output_n: int, sigma: float = 0.001):
        self._input_neurons_num: int = input_n
    ...
    def _init_params(self) -> None:
        prev_conn_num: int = self._input_neurons_num
    ...
    def _get_info(self) -> None:
        print(f"Network [{self._input_neurons_num} x {self._hidden_neurons} x {self._output_neurons}]")
